...
interface PortfolioSummaryMobileProps {
  portfolioData: PortfolioData
}

export const PortfolioSummaryMobile: React.FC<PortfolioSummaryMobileProps> = ({
  portfolioData
}) => {
    ...
    <motion.div className="relative h-full">
      <div className="relative w-full h-full rounded-3xl bg-white/[0.03] backdrop-blur-xl border border-white/[0.05] shadow-2xl shadow-black/50 overflow-hidden group">
        ...
        <div className="relative z-10 flex flex-col h-full p-4">
          ...
          {/* Total Portfolio Value - Larger Card */}
          <div className="mb-4">
            <motion.div 
              className="bg-white/[0.06] rounded-xl p-4 backdrop-blur-sm border border-white/[0.08] hover:bg-white/[0.08] transition-all"
